      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{mockStats.reviewedPRs} reviewed</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Of reviewed PRs</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Across all PRs</p>
          </CardContent>
        </Card>
      </div>
